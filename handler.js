...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '👑 khusus owner',
        owner: '🔱 khusus ownerbot*',
        mods: '🔰 khusus developer bro',
        premium: '💠 khusus *Premium*\n\nketik */premium* untuk membeli',
        group: '⚙️ ¡khusus group!',
        private: '📮 khusus private chat',
        admin: '🛡️ khusus admin kontol',
        botAdmin: '💥 bot harus jadi admin dulu',
        unreg: '📇 daftar dulu ngab caranya:\n\n*/reg nombre.edad*\n\n📌misal : */reg dylux.16*',
        restrict: '🔐 fitur owner ngab'
    }[type]
